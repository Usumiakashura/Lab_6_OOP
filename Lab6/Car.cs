...
namespace Lab6
{
    class Car : IComparable    //Наследует интерфейс IComparable
    {
        public string name;
        protected int speed;
        ...
        public override bool Equals(object obj) //Нужен для поиска
        {
            return ((obj as Car)?.name ?? "") == name;
        }
        public int CompareTo(object obj)    //Метод для последующей сортировки массива ПО ИМЕНИ методом Sort.Array с использованием интерфейса IComparable
        {
